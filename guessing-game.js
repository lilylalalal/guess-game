...
function checkGuess(secretNumber, inputnum) {
 ...
 //console.log(checkGuess(secretNumber, 6))
 //console.log(checkGuess(secretNumber, 100))
 //console.log(checkGuess(secretNumber, 10))
...
//}else {
  //console.log('Your guess is out of the range. Try again')
  //return askGuess()
